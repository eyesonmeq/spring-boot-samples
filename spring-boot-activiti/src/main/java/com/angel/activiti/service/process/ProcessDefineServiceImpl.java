...
import com.angel.activiti.mapper.process.ProcessDefineMapper;
import com.angel.activiti.model.process.ProcessDefineInfo;

/**
 * ADD FUNCTION
 *
 * @date: 2017年11月28日 下午6:42:16
 * @author li_ming 
 */
@Service
public class ProcessDefineServiceImpl implements ProcessDefineService {
	...
	public void deploy(int id) {
		...
		Deployment deployment = repositoryService.createDeployment()
				.addClasspathResource("processes/" + info.getProcessFile()).name(info.getProcessKey()).deploy();
