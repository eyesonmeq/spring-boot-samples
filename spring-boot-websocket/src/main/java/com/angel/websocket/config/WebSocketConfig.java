...
import com.angel.websocket.service.EchoService;
import com.angel.websocket.service.EchoServiceImpl;

/**
 * ADD FUNCTION
 *
 * @date: 2017年12月2日 下午12:13:28
 * @author li_ming 
 */
@Configuration
public class WebSocketConfig implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(echoWebSocketHandler(), "/echo").setAllowedOrigins("*").withSockJS().setHeartbeatTime(30000)
				.setSessionCookieNeeded(true).setTaskScheduler(taskScheduler());
	}
